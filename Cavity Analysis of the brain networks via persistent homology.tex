...
\doi{\url{www.pnas.org/cgi/doi/10.1073/pnas.0000000}}
...
\addtabletext{Comparisons of the network measures based on the information flow. Rather than averaged values for centralities, rankings of the nodes or subnetworks with respect to these measures would be more useful which is done but not present in the paper. According to these measures, hubs in the scaffolds belong to Dorsal Attention, Cognitive Control and Default Mode Networks which is in correlation with the previous results.}
\end{table}
